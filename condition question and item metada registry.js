...
window.ITEM_REGISTRY = {
    ...
    "Rye Bread":                { category: "bakery", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Wholemeal Wrap":           { category: "bakery", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: false } },
    "Wholemeal bread":          { category: "bakery", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Reduced fat milk":               { category: "dairy_eggs_fridge", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Champagne Leg Ham":              { category: "dairy_eggs_fridge", tag: "unhealthy", preselect: { healthy: false, neutral: true , unhealthy: true  } },
    ...
    "Chicken Breast Thinly Sliced":   { category: "dairy_eggs_fridge", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    // --- Drinks (13 items) ---
    "Spring Water":                             { category: "drinks", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Sparkling Water":                          { category: "drinks", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Soda water":                               { category: "drinks", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Orange Juice No added Sugar":              { category: "drinks", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Sports Drink Flavoured":                   { category: "drinks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Protein Water Berry Whey Protein Isolate": { category: "drinks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Wholegrain rice crackers":             { category: "snacks", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Multigrain crispbread crackers":       { category: "snacks", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Mini rice crisps milk chocolate":      { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Jelly beans":                          { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Liquorice":                            { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Marshmallows":                         { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Plain crackers":                       { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Pretzels":                             { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Original potato chips":                { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: true , unhealthy: true  } },
    "chicken potato chips":                 { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Salt & Vinegar chips":                 { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Cheese corn chips":                    { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Choclate chip cookies":                { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Biscuits shortbread creams":           { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Chocolate coated biscuits":            { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: true , unhealthy: true  } },
    "Chocolate cream wafers":               { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: true  } },
    "Nut bars chocolate peanut & almond":   { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: true , unhealthy: false } },
    "Rice bubbles snack bars":              { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Flavoured rainbow Sticks":             { category: "snacks", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Grapes":                                 { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Watermelon":                             { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Strawberries":                           { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "blueberries":                            { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "pears":                                  { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Bannanas":                               { category: "fruit", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: true  } },
    "Oranges":                                { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Kiwi fruit":                             { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Canned peaches":                         { category: "fruit", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Banana Chips":                           { category: "fruit", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Extra lean beef mince":    { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Beef sizzle steak":        { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Lamb leg diced":           { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Pork sizzle steaks":       { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Extra lean pork mince":    { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Kangaroo diced":           { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Chicken breast fillets":   { category: "meat_seafood", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: true  } },
    "Turkey mince":             { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Basa":                     { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Tuna steaks":              { category: "meat_seafood", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Thin Bbq sausages":        { category: "meat_seafood", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: true  } },
    "Beef sausages":            { category: "meat_seafood", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Beef burgers patties":     { category: "meat_seafood", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: true  } },
    "Lamb burgers":             { category: "meat_seafood", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Beef Bbq burgers":         { category: "meat_seafood", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Kransky bites":            { category: "meat_seafood", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    // --- Freezer (29 items) ---
    "Frozen mixed berries":                                 { category: "frozen", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: true  } },
    ...
    "Frozen Vegetable Mix":                                 { category: "frozen", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Frozen Dessert Cones - Brownie":                       { category: "frozen", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Chocolate cake":                                       { category: "frozen", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Connoisseur Camarosa Strawberry Gourmet Ice Cream 1L": { category: "frozen", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Connoisseur Ice Cream Classic Vanilla Tub 1L":         { category: "frozen", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Puff Pastry Sheets":                                   { category: "frozen", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Tortillas":                         { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Oats":                              { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Long grain rice":                   { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Pasta spaghetti":                   { category: "pantry", tag: "healthy", preselect: { healthy: true , neutral: false, unhealthy: false } },
    "Pasta penne":                       { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Glass noodles":                     { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Chick peas":                        { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Black beans":                       { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Baked beans":                       { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Red split lentils":                 { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Springwater tuna":                  { category: "pantry", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: false } },
    "Sprinwater salmon":                 { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Unsalted mixed nuts":               { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Unsalted cashews":                  { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Organic peanut butter":             { category: "pantry", tag: "healthy", preselect: { healthy: true , neutral: false, unhealthy: false } },
    "Beetroot":                          { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Pumpkin seeds":                     { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Black chia seeds":                  { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Sunflower seeds":                   { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Walnuts":                           { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    "Almonds":                           { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Chocolate flavoured cereal":        { category: "pantry", tag: "unhealthy", preselect: { healthy: true , neutral: true , unhealthy: true  } },
    ...
    "Green salad bowl":                      { category: "ready_to_eat", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Beef cheese & bacon pie":               { category: "ready_to_eat", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "tomatoes":       { category: "vegetables", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: false } },
    ...
    "Asian choy pak": { category: "vegetables", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
