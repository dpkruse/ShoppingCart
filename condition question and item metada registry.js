...
window.ITEM_REGISTRY = {
    ...
    // --- Drinks (13 items) ---
    "Spring Water":                             { category: "drinks", tag: "healthy", preselect: { healthy: true , neutral: true , unhealthy: false } },
    ...
    "Chocolate cake":                                       { category: "frozen", tag: "unhealthy", preselect: { healthy: true , neutral: true , unhealthy: true  } },
    ...
    "Springwater tuna":                  { category: "pantry", tag: "healthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
    ...
    "Chocolate flavoured cereal":        { category: "pantry", tag: "unhealthy", preselect: { healthy: false, neutral: false, unhealthy: false } },
